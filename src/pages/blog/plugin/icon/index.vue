...
<template>
  ...
  >
    ...
    >
      ...
      >
        <h1
          class="mb-20px text-18px font-500"
        >
          Icon图标选择器
        </h1>
    ...
    <ElCard
      header="自定义图标示例"
      class="mt-10px card-wrapper"
    >
      <div
        class="pb-12px text-16px"
      >
