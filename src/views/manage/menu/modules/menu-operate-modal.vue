        ...
        <ElRow>
          ...
          >
            ...
            >
              ...
              >
                <ElOption
                  v-for="{ label, value } in pageOptions"
                  :key="value"
                  :label="label"
                  :value="value"
                />
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <ElFormItem
                      :prop="['query', index.toString(), 'value']"
                    >
                      <ElInput
                        v-model="item.value"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <ElFormItem
                      :prop="['buttons', index.toString(), 'code']"
                    >
                      <ElInput
                        v-model="item.code"
                        placeholder="请输入按钮编码"
                  ...
                  >
                    <ElFormItem
                      :prop="['buttons', index.toString(), 'desc']"
                    >
                      <ElInput
                        v-model="item.desc"
                        placeholder="请输入按钮描述"
