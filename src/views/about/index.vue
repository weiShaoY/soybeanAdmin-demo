...
<template>
  <ElSpace direction="vertical" fill :size="16">
    <ElCard :header="'关于'" size="small" segmented class="card-wrapper">
      <p>`SoybeanAdmin 是一个优雅且功能强大的后台管理模板，基于最新的前端技术栈，包括 Vue3, Vite5, TypeScript, Pinia 和 UnoCSS。它内置了丰富的主题配置和组件，代码规范严谨，实现了自动化的文件路由系统。此外，它还采用了基于 ApiFox 的在线Mock数据方案。SoybeanAdmin 为您提供了一站式的后台管理解决方案，无需额外配置，开箱即用。同样是一个快速学习前沿技术的最佳实践。`</p>
    </ElCard>
    <ElCard :header="'项目信息'" size="small" class="card-wrapper">
    ...
    <ElCard :header="'开发依赖'" class="card-wrapper">
      <ElDescriptions label-placement="left" border :column="column">
