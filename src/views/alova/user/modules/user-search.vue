          ...
          <ElRow :gutter="24">
            ...
            <ElCol :lg="6" :md="8" :sm="12">
              <ElFormItem :label="'性别'" prop="userGender">
                <ElSelect v-model="model.userGender" :placeholder="'请选择性别'" clearable>
                  <ElOption
            ...
            <ElCol :lg="6" :md="8" :sm="12">
              <ElFormItem :label="'性别'" prop="userStatus">
                <ElSelect v-model="model.status" :placeholder="'请选择用户状态'" clearable>
                  <ElOption
